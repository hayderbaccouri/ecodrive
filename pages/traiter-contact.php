...
if (count($contactHistory) >= 3) {
    $_SESSION['contact_error'] = 'Trop de tentatives. R̩essayez dans 10 minutes.';
...
elseif (strlen($message) < 10) $_SESSION['contact_error'] = 'Message trop court (min. 10 caract̬res).';
else {
