    ...
    <div class="contact-wrapper">
      <div class="contact-form-section">
        <?php if (($_SESSION['user']['role'] ?? '') === 'admin'): ?>
          ...
          <p style="color:var(--gray)">Les messages envoyés via ce formulaire atterrissent dans votre panneau d'administration, onglet Messages.</p>
          <div style="margin-top:1rem">
            <a href="<?= $asset_base ?>php/admin.php?tab=messages" class="btn btn-primary">📨 Voir les messages reçus</a>
            <a href="<?= $asset_base ?>php/admin.php?tab=newsletter" class="btn btn-ghost">✉️ Newsletter</a>
          </div>
        <?php else: ?>
...
(function(){
  ...
  L.marker([36.8065, 10.1815]).addTo(map)
    .bindPopup('<em>EcoDrive</em><br>123 Rue de la Liberté, Tunis')
    .openPopup();
})();
</script>
