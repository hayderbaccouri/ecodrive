...
<nav class="breadcrumb" aria-label="breadcrumb">
  <a href="../index.php">Accueil</a> / <a href="../php/catalogue.php">Catalogue</a> / <span class="breadcrumb-current">Mercedes-Benz Classe C 2026</span>
</nav>

<main class="page-fade-in">
    <?php $range_km = 753; include '../php/car_slider.php'; renderCarSlider('images/mercedes-classe-c-2026/', '1-Mercedes-Benz-Classe-C-2026.jpg', 'Mercedes-Benz Classe C 2026'); ?>
    ...
    <section class="car-overview reveal reveal-up">
      ...
      <div class="spec-card">
        ...
        <div class="spec-value">94,5 kWh<small>Lithium-ion NMC</small></div>
      </div>
      <div class="spec-card">
        <div class="spec-label">Autonomie</div>
        <div class="spec-value">753 km<small>Cycle WLTP</small></div>
      </div>
      <div class="spec-card">
        <div class="spec-label">0-100 km/h</div>
        <div class="spec-value">4,0 s<small>210 km/h</small></div>
      </div>
      <div class="spec-card">
        <div class="spec-label">Poids</div>
        <div class="spec-value">2 200 kg<small>Coffre 480 L</small></div>
      </div>
    </div>
    </section>
      ...
      <div class="specs-grid">
        ...
        <div class="spec-group">
          ...
          <dl>
            ...
            <div class="spec-row battery-visual"><dt>Niveau</dt><dd><div class="battery-bar"><div class="battery-track"><div class="battery-fill high" data-width="87%"></div></div><span class="battery-label">94.5 kWh</span></div></dd></div></dl>
        </div>
        <div class="spec-group">
          <h3>Recharge</h3>
          <dl>
            <div class="spec-row"><dt>AC (Wallbox)</dt><dd>8 h 30 (11 kW)</dd></div>
            <div class="spec-row"><dt>DC (Rapide)</dt><dd>22 min (10-80%, 330 kW)</dd></div>
          </dl>
        </div>
        <div class="spec-group">
          <h3>Dimensions</h3>
          <dl>
            ...
            <div class="spec-row"><dt>Coffre</dt><dd>480 L</dd></div>
          </dl>
        </div>
      </div>
    </section>
