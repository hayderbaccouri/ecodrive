...
function emailPasswordReset($email, $token, $scheme, $host) {
    ...
    $body = "<h2>Réinitialisation de mot de passe</h2>"
          ...
          . "<p><a href='$link' style='display:inline-block;padding:12px 24px;background:#00e5a0;color:#000;text-decoration:none;border-radius:999px;font-weight:600'>Réinitialiser</a></p>"
...
function emailWelcome($user) {
    $body = "<h2>Bienvenue chez EcoDrive !</h2>"
          ...
          . "<p><a href='https://ecodrive.tn/php/catalogue.php' style='display:inline-block;padding:12px 24px;background:#00e5a0;color:#000;text-decoration:none;border-radius:999px;font-weight:600'>Parcourir le catalogue</a></p>";
