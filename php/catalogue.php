...
<head>
  ...
  <style>.pagination{display:flex;justify-content:center;gap:.5rem;margin:2rem 0}.pagination-link{display:inline-flex;align-items:center;justify-content:center;width:40px;height:40px;border-radius:8px;background:var(--white);border:1px solid var(--border);color:var(--grey-2);text-decoration:none;font-size:.95rem;transition:all .2s}.pagination-link:hover{background:var(--accent);color:var(--white);border-color:var(--accent)}.pagination-link.active{background:var(--accent);color:var(--white);font-weight:500}</style>
</head>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="card-actions">
                <a href="<?= htmlspecialchars('../' . ltrim($voiture['details_page'] ?: '#', '/'), ENT_QUOTES, 'UTF-8') ?>" class="btn-details">
