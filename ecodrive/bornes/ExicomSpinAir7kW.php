...
<head>
  ...
  <title>Exicom Spin Air 7.4 kW — EcoDrive</title>
...
<body>
  ...
  <div class="breadcrumb">
    ...
    <span>›</span>
    <span class="breadcrumb-current">Exicom Spin Air 7.4 kW</span>
  </div>
    ...
    <div class="borne-visual">
      ...
      <div class="borne-img-frame">
        <div class="borne-img-box">
          <img src="../images/SPIN-AIR-11 (2).png" alt="Exicom Spin Air 7.4 kW"
  ...
  <section class="how-section">
    ...
    <div class="steps-grid">
      <div class="step-card">
        ...
        <div class="step-title">Installation fixe</div>
      ...
      <div class="step-card">
        ...
        <div class="step-title">Connexion &amp; configuration</div>
        <p class="step-text">Connectez la borne à votre réseau Wi-Fi ou via 4G/LTE. Configurez vos horaires de recharge
          depuis l'application mobile pour profiter des heures creuses.</p>
      </div>
      <div class="step-card">
  ...
  <section class="specs-section">
    ...
    <table class="specs-table">
      ...
      <tbody>
        ...
        <tr>
          <td>Contrôle</td>
          <td>Application mobile, programmation horaire</td>
        </tr>
        <tr>
          <td>Installation</td>
