...
<head>
  ...
  <title>BYD Atto 3 — EcoDrive</title>
  ...
  <main>
    <section class="car-hero">
      <div class="hero-image-wrap">
        <img loading="lazy" src="../images/byd-atto-3.jpg" alt="BYD Atto 3">
        <div class="hero-overlay">
          <h1>BYD Atto 3</h1>
          <p class="hero-tagline">SUV compact au rapport qualité-prix imbattable. Grande autonomie, batterie Blade, équipements de série complets.</p>
        </div>
      </div>
    </section>
    ...
    <div class="car-actions-bar">
      ...
      <a href="../php/reservation.php?car=3" class="btn-reserve">Réserver un essai</a>
    </div>
    ...
    <section class="specs-highlight">
      ...
      <div class="spec-card">
        ...
        <div class="spec-value">60,5 kWh<small>Blade LFP</small></div>
      </div>
      <div class="spec-card">
      ...
      <div class="spec-card">
        ...
        <div class="spec-value">7,3 s<small>160 km/h</small></div>
      </div>
      <div class="spec-card">
        <div class="spec-label">Poids</div>
        <div class="spec-value">1 750 kg<small>Coffre 440 L</small></div>
      </div>
    </section>
      ...
      <div class="specs-grid">
        <div class="spec-group">
          ...
          <dl>
            ...
            <div class="spec-row"><dt>Couple max</dt><dd>310 Nm</dd></div>
        ...
        <div class="spec-group">
          ...
          <dl>
            <div class="spec-row"><dt>Capacité batterie</dt><dd>60,5 kWh</dd></div>
        ...
        <div class="spec-group">
          ...
          <dl>
            ...
            <div class="spec-row"><dt>DC (Rapide)</dt><dd>29 min (10-80%, 110 kW)</dd></div>
          </dl>
        </div>
        <div class="spec-group">
          <h3>Dimensions</h3>
    ...
    <section class="reservation-cta">
      <div class="cta-box">
        ...
        <a href="../php/reservation.php?car=3" class="cta-btn">Réserver un essai gratuit</a>
      </div>
    </section>
  </main>
