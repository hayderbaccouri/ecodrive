...
<head>
  ...
  <title>Renault Megane E-Tech 2026 — EcoDrive</title>
  ...
  <main>
    <section class="car-hero">
      <div class="hero-image-wrap">
        <img loading="lazy" src="../images/renault-megane-e-tech.jpg" alt="Renault Megane E-Tech 2026">
        <div class="hero-overlay">
          <h1>Renault Megane E-Tech 2026</h1>
          <p class="hero-tagline">Berline compacte électrique française. Bonne autonomie, design élégant, système OpenR Link avec Google.</p>
        </div>
      </div>
    </section>
    ...
    <div class="car-actions-bar">
      <div class="price-block">
        ...
        <span class="price-value">140 000 <small>DT</small></span>
      </div>
    ...
    <section class="specs-highlight">
      <div class="spec-card">
        ...
        <div class="spec-value">220 ch<small>160 kW</small></div>
      </div>
      <div class="spec-card">
        <div class="spec-label">Batterie</div>
        <div class="spec-value">60 kWh<small>Lithium-ion NMC</small></div>
      </div>
      <div class="spec-card">
      ...
      <div class="spec-card">
        ...
        <div class="spec-value">7,4 s<small>160 km/h</small></div>
      </div>
      <div class="spec-card">
        <div class="spec-label">Poids</div>
        <div class="spec-value">1 636 kg<small>Coffre 440 L</small></div>
      </div>
    </section>
    ...
    <section class="specs-detail">
      <div class="specs-grid">
        <div class="spec-group">
          <h3>Motorisation</h3>
          <dl>
            <div class="spec-row"><dt>Puissance max</dt><dd>220 ch (160 kW)</dd></div>
            <div class="spec-row"><dt>Couple max</dt><dd>300 Nm</dd></div>
        ...
        <div class="spec-group">
          ...
          <dl>
            <div class="spec-row"><dt>Capacité batterie</dt><dd>60 kWh</dd></div>
        ...
        <div class="spec-group">
          <h3>Recharge</h3>
          <dl>
            <div class="spec-row"><dt>AC (Wallbox)</dt><dd>5 h 30 (11 kW)</dd></div>
            <div class="spec-row"><dt>DC (Rapide)</dt><dd>33 min (10-80%, 130 kW)</dd></div>
          </dl>
        </div>
        <div class="spec-group">
          <h3>Dimensions</h3>
          <dl>
            <div class="spec-row"><dt>Longueur</dt><dd>4 200 mm</dd></div>
            <div class="spec-row"><dt>Largeur</dt><dd>1 841 mm</dd></div>
            <div class="spec-row"><dt>Hauteur</dt><dd>1 501 mm</dd></div>
    ...
    <section class="reservation-cta">
      <div class="cta-box">
        <h2>Essayez la Renault Megane E-Tech 2026</h2>
