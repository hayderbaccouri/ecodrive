  ...
  <main>
    <section class="car-hero">
      <div class="hero-image-wrap">
        <img loading="lazy" src="../images/byd-dolphin.jpg" alt="BYD Dolphin Surf">
        <div class="hero-overlay">
          <h1>BYD Dolphin Surf</h1>
          <p class="hero-tagline">Citadine électrique agile et connectée. Parfaite pour la ville, consommation réduite, recharge rapide.</p>
        </div>
      </div>
    </section>
    ...
    <section class="specs-highlight">
      ...
      <div class="spec-card">
        ...
        <div class="spec-value">38,8 kWh<small>Blade LFP</small></div>
      </div>
      <div class="spec-card">
        <div class="spec-label">Autonomie</div>
        <div class="spec-value">300 km<small>Cycle WLTP</small></div>
      </div>
      <div class="spec-card">
        <div class="spec-label">0-100 km/h</div>
        <div class="spec-value">10,8 s<small>150 km/h</small></div>
      </div>
      <div class="spec-card">
        <div class="spec-label">Poids</div>
        <div class="spec-value">1 285 kg<small>Coffre 280 L</small></div>
      </div>
    </section>
      ...
      <div class="specs-grid">
        <div class="spec-group">
          ...
          <dl>
            ...
            <div class="spec-row"><dt>Couple max</dt><dd>180 Nm</dd></div>
        ...
        <div class="spec-group">
          ...
          <dl>
            <div class="spec-row"><dt>Capacité batterie</dt><dd>38,8 kWh</dd></div>
            <div class="spec-row"><dt>Type de batterie</dt><dd>Blade LFP</dd></div>
            <div class="spec-row"><dt>Autonomie WLTP</dt><dd>300 km</dd></div>
        ...
        <div class="spec-group">
          <h3>Recharge</h3>
          <dl>
            <div class="spec-row"><dt>AC (Wallbox)</dt><dd>4 h 10 (7,4 kW)</dd></div>
            <div class="spec-row"><dt>DC (Rapide)</dt><dd>30 min (10-80%, 60 kW)</dd></div>
          </dl>
        </div>
        <div class="spec-group">
          <h3>Dimensions</h3>
          <dl>
            ...
            <div class="spec-row"><dt>Coffre</dt><dd>280 L</dd></div>
          </dl>
        </div>
      </div>
    </section>
